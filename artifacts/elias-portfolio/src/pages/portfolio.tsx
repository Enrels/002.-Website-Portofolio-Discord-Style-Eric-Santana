        ...
        <section id="home" className="min-h-[80vh] flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <img
              src={heroRealImg}
              alt="Eric Santana"
              className="w-full max-w-[400px] mx-auto object-cover object-top border-b border-primary relative z-10 rounded-sm"
              style={{ maxHeight: "480px" }}
            />
            <DotsPattern className="absolute bottom-10 right-10 text-primary z-0" />
            <div className="mt-4 p-2 border border-border inline-flex items-center gap-2 relative z-10 w-full max-w-[400px] mx-auto" style={{ backgroundColor: "#282C33" }}>
            ...
            <div className="flex flex-wrap gap-4">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="border border-border bg-card min-w-[180px] max-w-[260px]"
                >
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start">
            ...
            >
              ...
              <img
                src={aboutRealImg}
                alt="Eric Santana"
                className="w-full max-w-[320px] mx-auto border-b border-primary relative z-10 object-cover rounded-sm"
